...
// function Chat({posts}: { posts: string[] }) {
...
//     const messagesStart = React.useRef<null | HTMLDivElement>(null);
...
//     const heightRef = React.useRef<HTMLDivElement | null>(null);
...
//             }),     
//         }).then(async () => {
//             toast.loading('Post to database...', { 
//                 id: notification,
//             })
//             setPlaceholder("Post to database...");
